...
def prepare_judgement_check(record, expected):
    ...
    NOTE(D4/judgement): verdict is filled by a person (see
      ...
      What you may NOT do is substring-match the must_record strings and
      call it a check. "approved_total 2180" would pass on a record that
      printed the number inside a sentence saying the opposite.
    """
    return {
