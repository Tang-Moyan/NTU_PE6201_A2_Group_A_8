...
--------------------------------------------------------------------
THIS FILE IS D1. It is the thing being marked, so read every line
before you change one - and do not hand it to a framework, because a
loop a library owns is a loop with nothing of yours in it.

The loop below WORKS. The TODO markers are the decisions that are
yours rather than ours; run

    python A2_main/code_todo.py

to see all of them across the repository at once.
====================================================================
"""
import time

import config
from D2_tool_layer import prompt, tools
from D3_guardrails.guardrails import Guardrails, GuardrailStop
from D5_model_battery.backends import make_backend
